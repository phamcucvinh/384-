...
// STRAT_SUPERTREND,    // Super Trend
  ...
  STRAT_CONSERVATIVE_SCALPING,   // Conservative Scalping (Nomadtown)
  STRAT_PRICE_ACTION_TRADING,    // Price Action Trading (Support/Resistance)
  STRAT_VOLATILITY_BREAKOUT,     // Volatility Breakout Trading
  STRAT_STATISTICAL_ARBITRAGE,   // Statistical Arbitrage Trading (Pair Trading + ML)
