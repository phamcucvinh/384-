...
// Include conservative scalping strategy.
#include "../strategies/conservative-scalping/Stg_ConservativeScalping.mqh"
// Include price action trading strategy.
#include "../strategies/price-action/Stg_PriceActionTrading.mqh"
// Include volatility breakout strategy.
#include "../strategies/volatility-breakout/Stg_VolatilityBreakout.mqh"
// Include statistical arbitrage strategy.
#include "../strategies/statistical-arbitrage/Stg_StatisticalArbitrage.mqh"
 ...
 public:
  ...
  static Strategy* StrategyCreateByEnum(ENUM_STRATEGY _sid, ENUM_TIMEFRAMES _tf = PERIOD_CURRENT) {
    switch (_sid) {
      ...
      case STRAT_CONSERVATIVE_SCALPING:
        return StrategyInit<Stg_ConservativeScalping>(_tf);
      case STRAT_PRICE_ACTION_TRADING:
        return StrategyInit<Stg_PriceActionTrading>(_tf);
      case STRAT_VOLATILITY_BREAKOUT:
        return StrategyInit<Stg_VolatilityBreakout>(_tf);
      case STRAT_STATISTICAL_ARBITRAGE:
        return StrategyInit<Stg_StatisticalArbitrage>(_tf);
      default:
      case STRAT_NONE:
        break;
    }
